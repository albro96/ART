...
#         scheduler = build_lambda_sche(
#             optimizer, sche_config.kwargs, last_epoch=last_epoch
#         )  # misc.py
#     elif sche_config.type == "StepLR":
#         scheduler = torch.optim.lr_scheduler.StepLR(
#             optimizer, last_epoch=last_epoch, **sche_config.kwargs
#         )
#     elif sche_config.type == "GradualWarmup":
#         scheduler_steplr = torch.optim.lr_scheduler.StepLR(
#             optimizer, last_epoch=last_epoch, **sche_config.kwargs_1
#         )
#         scheduler = GradualWarmupScheduler(
#             optimizer, after_scheduler=scheduler_steplr, **sche_config.kwargs_2
#         )
